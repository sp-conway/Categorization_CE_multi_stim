jsPsych.plugins['draw-demo-lines'] = (function() {
    ...
    plugin.info = {
        ...
        parameters: {
            ...
            in_cat_text: {
                ...
                pretty_name: 'In-Category Text',
                default: "Stimuli IN the Category"
            },
            out_cat_text: {
                type: jsPsych.plugins.parameterType.HTML_STRING,
                pretty_name: 'Out-of-Category Text',
                default: "Stimuli NOT IN the Category"
            }
        }
    }
    ...
    plugin.trial = function(display_element, trial) {
        ...
        var in_cat_text = trial.in_cat_text;
        var out_cat_text = trial.out_cat_text;
        ...
        console.log("x locs = ", x_locs, "y center out = ", y_center_out);

        for (let i = 0; i < out_category.length; i++) {
