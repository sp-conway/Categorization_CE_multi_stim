...
This experiment was created using PsychoPy3 Experiment Builder (v2024.2.5),
    on Tue 18 Mar 2025 03:02:10 PM EDT
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/home/shop/experiments/line_categorization_experiment/line_categorization_exp_updated.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisInstructions_loop in instructions_loop:
        ...
        while continueRoutine:
            ...
            if instr_cont1.status == STARTED and not waitOnFlip:
                theseKeys = instr_cont1.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        while continueRoutine:
            ...
            if instr_cont2.status == STARTED and not waitOnFlip:
                theseKeys = instr_cont2.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        while continueRoutine:
            ...
            if instr_cont3.status == STARTED and not waitOnFlip:
                theseKeys = instr_cont3.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        while continueRoutine:
            ...
            if instr_cont4.status == STARTED and not waitOnFlip:
                theseKeys = instr_cont4.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        while continueRoutine:
            ...
            if instr_cont5.status == STARTED and not waitOnFlip:
                theseKeys = instr_cont5.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        while continueRoutine:
            ...
            if instr_cont6.status == STARTED and not waitOnFlip:
                theseKeys = instr_cont6.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
    ...
    for thisDemo_loop in demo_loop:
        ...
        while continueRoutine:
            ...
            if learn_start_reps.status == STARTED and not waitOnFlip:
                theseKeys = learn_start_reps.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
    ...
    for thisLearn_trial in learn_trials:
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['u','i'], ignoreKeys=None, waitRelease=False)
    ...
    # completed 1.0 repeats of 'learn_trials'
    ...
    for thisTransfer_instructions_loop in transfer_instructions_loop:
        ...
        while continueRoutine:
            ...
            if transfer_cont1.status == STARTED and not waitOnFlip:
                theseKeys = transfer_cont1.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        while continueRoutine:
            ...
            if transfer_cont2.status == STARTED and not waitOnFlip:
                theseKeys = transfer_cont2.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        while continueRoutine:
            ...
            if transfer_cont3.status == STARTED and not waitOnFlip:
                theseKeys = transfer_cont3.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
        ...
        routineTimer.reset()
    # completed 1.0 repeats of 'transfer_instructions_loop'
        ...
        for thisTransfer_trinary_dummy in transfer_trinary_dummy:
            ...
            while continueRoutine:
                ...
                if key_resp_transfer_trinary.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_transfer_trinary.getKeys(keyList=['j','k','l'], ignoreKeys=None, waitRelease=False)
        ...
        for thisTransfer_binary_dummy in transfer_binary_dummy:
            ...
            while continueRoutine:
                ...
                if key_resp_transfer_binary.status == STARTED and not waitOnFlip:
                    theseKeys = key_resp_transfer_binary.getKeys(keyList=['j','k'], ignoreKeys=None, waitRelease=False)
    ...
    while continueRoutine:
        ...
        if cont_to_debrief.status == STARTED and not waitOnFlip:
            theseKeys = cont_to_debrief.getKeys(keyList=['space'], ignoreKeys=None, waitRelease=False)
